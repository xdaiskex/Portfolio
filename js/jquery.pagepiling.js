        ...
        */
        function scrollPage(destination, animated) {
            ...
            if (v.yMovement === 'down') {
                ...
                if(!options.css3){
                    v.sectionsToMove.each(function(index){
                        if(index != v.activeSection.index('.pp-section')){
                            $(this).delay('slow').css(getScrollProp(v.scrolling));
                        }
                    });
                }
                if(counter == 1 && v.yMovement === 'down'){
                ...
                else if(counter == 2 && v.yMovement === 'down'){
                ...
                else if(counter == 3 && v.yMovement === 'down'){
                ...
                counter++;
                $('.hands').css("left", "-130px");
                $('.hands').css("bottom", "-100px");
                $('.hands').css("display", "none");

                $('.hands2').css("left", "-130px");
                $('.hands2').css("bottom", "-100px");
                $('.hands2').css("display", "none");

                $('.hands3').css("left", "-130px");
                $('.hands3').css("bottom", "-100px");
                $('.hands3').css("display", "none");
            ...
            //scrolling up (moving section down to the viewport)
                ...
                counter--;
                $('.hand').css("display", "none");
                $('.hand').css("right", "100px"); 
                $('.hand').css("bottom", "-350px"); 

                $('.hand2').css("display", "none");
                $('.hand2').css("right", "100px"); 
                $('.hand2').css("bottom", "-350px"); 

                $('.hand3').css("display", "none");
                $('.hand3').css("right", "100px"); 
                $('.hand3').css("bottom", "-350px"); 
